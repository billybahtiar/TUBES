                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tr>
                                        <th>Telepon</th>
                                        <td><?php echo e($mahasiswa->telepon); ?></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <th>Photo</th>
                                        <td>
                                            <img src="<?php echo e(Storage::url($mahasiswa->photo)); ?>" width="200" alt="">
                                        </td>
                                    </tr>
                                </table>
                            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Web E\Project Laravel\resources\views/admin/mahasiswa/show.blade.php ENDPATH**/ ?>